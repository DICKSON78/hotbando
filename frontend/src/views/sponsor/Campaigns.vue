<template>
  <div class="space-y-5">
    <div class="flex items-center justify-between">
      ...
      <router-link to="/sponsor/campaigns/create" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> New Campaign</router-link>
    </div>
    ...
    <div class="bg-gradient-to-br from-brand-50 to-white rounded-2xl border border-brand-100 shadow-sm overflow-hidden">
      <div class="p-5">
        <table class="tbl-shadcn">
          <thead><tr><th>Title</th><th>Type</th><th>Status</th><th>Views</th><th>Date</th></tr></thead>
          <tbody>
            ...
            <tr v-if="!campaigns.length"><td colspan="5" class="text-center text-gray-400 py-10">No campaigns yet. <router-link to="/sponsor/campaigns/create" class="text-brand-500 font-medium hover:underline">Create one</router-link></td></tr>
          </tbody>
        </table>
      </div>
    </div>
